    ...
    <>
      <div className="container">
        ...
        <Text>
          ...
          <p>
            Sensibiliser les population à la cause et au bien être animal en
            ...
            justesse à l'abattoir, étant considérées comme plus assez rentables
            par les producteurs. Il s'agit de montrer aux citoyens pourquoi il
            est important de consommer, à minima, des produits issus de poules
            élevées en plein air et que le bien être animal n'est pas à
            négliger.
          </p>
        </Text>
        ...
        <TextAndImage>
          <div>
            ...
            <p>
              ...
              d'associer des associations d'insertion professionnelle et social,
              de sa conception à sa gestion en passant par son installation.
            </p>
            <h4>Pédagogique</h4>
            <p>
              ...
              et de la preservation des ressources à travers un parcours
